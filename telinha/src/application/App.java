...
public class App extends Application{
    ...
    public static void main(String[] args) {
       ...
       try {
     	   ...
     	   if(conn_verificar_ids_turnos_abertos == null) {
     		  Platform.runLater(() -> {
                  Alert erro_conexao = new Alert(AlertType.WARNING);
                  erro_conexao.setTitle("Erro!");
                  erro_conexao.setHeaderText(null);
                  erro_conexao.setContentText("Não foi possível se conectar ao banco de dados. Verifique se o XAMPP está iniciado e o MySQL está rodando.");
                  erro_conexao.showAndWait();
              });
     	   }else {
