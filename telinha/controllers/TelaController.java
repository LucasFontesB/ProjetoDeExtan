    ...
    void Cadastrar_Passeio(ActionEvent event) {
    	...
    	try {
    	    ...
    	    try {
    	        ...
    	        System.out.print(valor_total_formatado+"\n");
    	    ...
    	    try {
    	        ...
    	        valor_pago = Float.parseFloat(valor_total_formatado);
    	        
    	        valor_pago_label.setText(String.format("R$ "+valor_total+"0"));
